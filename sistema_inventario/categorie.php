 ...
 if(isset($_POST['add_cat'])){
   ...
   if(empty($errors)){
      ...
      if($db->query($sql)){
        ...
        $session->msg("d", "Lo siento No se pudo insertar.");
        redirect('categorie.php',false);
      }
   } else {
        ...
        <div class="panel-body">
          <form method="post" action="categorie.php">
            <div class="form-group">
                <input type="text" class="form-control" name="categorie-name" placeholder="Nombre de Categoria">
            </div>
          ...
          <table class="table table-bordered table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th>Categorias</th>
                    <th class="text-center" style="width: 100px;">Verificar</th>
                </tr>
            </thead>
            <tbody>
