     ...
     <?php echo display_msg($msg); ?>
      <form method="post" action="change_password.php" class="clearfix">
        <div class="form-group">
              ...
              <input type="password" class="form-control" name="new-password" placeholder="nuevo password">
        </div>
        <div class="form-group">
              <label for="oldPassword" class="control-label">Contraseña anterior</label>
              <input type="password" class="form-control" name="old-password" placeholder="password anterior">
        </div>
